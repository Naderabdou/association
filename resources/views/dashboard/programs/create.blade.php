...
@section('title', transWord('اضافه برامجنا'))
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="#">{{ transWord('اضافة برامجنا') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('اضافة برنامج جديده') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" action="{{ route('admin.ourPrograms.store') }}"
                                        method="POST" enctype="multipart/form-data" id="createOurProgramsForm">
                                        @csrf
                                        <div class="row">
