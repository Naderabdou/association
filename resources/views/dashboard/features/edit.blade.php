                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-vertical"
                                        action="{{ route('admin.features.update',$feature->id) }}" method="POST" id="updateForm"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6" id="desc_ar">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control tinyEditor" name="desc_ar" rows="10">{{ old('desc_ar',$feature->desc_ar) }}</textarea>
                                                    @error('desc_ar')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
                                            ...
                                            <div class="col-6" id="desc_en">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control tinyEditor" name="desc_en" rows="10">{{ old('desc_en',$feature->desc_en) }}</textarea>
                                                    @error('desc_en')
                                                        <span class="alert alert-danger">
                                                            <small class="errorTxt">{{ $message }}</small>
                                                        </span>
