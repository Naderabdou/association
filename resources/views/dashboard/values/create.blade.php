                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('اضافة قيمة جديده') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" action="{{ route('admin.ourValues.store') }}"
                                        method="POST" enctype="multipart/form-data" id="createOurValuesForm">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="icon"
                                                        class="form-label">{{ transWord('icon') }}</label>
