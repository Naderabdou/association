...
@section('title', transWord('طلبات العضوية'))
@push('css')
    <style>
        .badge-golden {
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.memberships.index') }}">{{ transWord('طلبات العضوية') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif ($membership->type == 'private_sector')
                                                        <span class="badge badge-light-info">{{ transWord('موظف  خاص') }}
                                                            <i class="fas fa-building"></i>
                                                        </span>
                                                    @elseif ($membership->type == 'government_sector')
                                                        <span
                                                            class="badge badge-light-success">{{ transWord('موظف  حكومي') }}
                                                ...
                                                <td>
                                                    @if ($membership->payment_receipt == null)
                                                        <img src="{{ asset('dashboard/images/notFile.png') }}"
                                                            alt="" width="30px" hight="30px">
                                                    @else
                                                        <a href="{{ $membership->payment_receipt_path  }}"
                                                            target="_blank"> <img
                                                                src="{{$membership->payment_receipt_path  }}"
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Second group">
                                                        <a href="{{ route('admin.partners.edit', $membership->id) }}"
                                                            class="btn btn-sm btn-primary">

                                                            <i class=" fa-solid fas fa-reply"></i>

                                                        </a>
                                                        <a href="{{ route('admin.partners.destroy', $membership->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-5">
                                                                            <b>{{ transWord('جهة العمل') }} : </b>
                                                                        </div>
                                                                        <div class="col-lg-7">
                                                                            {{ $membership->workplace }}
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-5">
                                                                            <b>{{ transWord(' ايصال سداد رسوم العضوية') }}
                                                                                : </b>
                                                                        </div>
                                                                        <div class="col-lg-7">
                                                                            @if ($membership->payment_receipt == null)
