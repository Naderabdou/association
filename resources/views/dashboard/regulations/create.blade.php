...
@section('title', transWord('اضافه لوئح وسياسات جديدة'))
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="#">{{ transWord('اضافه لوئح وسياسات جديدة') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{ transWord('اضافه لوئح وسياسات جديدة') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical" action="{{ route('admin.regulations.store') }}"
                                        method="POST" id="regulationscreateForm" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
